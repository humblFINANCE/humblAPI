...
<h3 align="center">humblapi</h3>

<div align="center">

  [![Open in Dev Containers](https://img.shields.io/static/v1?label=Dev%20Containers&message=Open&color=blue&logo=visualstudiocode)](https://vscode.dev/redirect?url=vscode://ms-vscode-remote.remote-containers/cloneInVolume?url=https://github.com/humblFINANCE/humblFINANCE-api)
  ...
  [![GitHub Issues](https://img.shields.io/github/issues/jjfantini/humblapi.svg)](https://github.com/jjfantini/humblapi/issues)
  [![GitHub Pull Requests](https://img.shields.io/github/issues-pr/jjfantini/humblapi.svg)](https://github.com/jjfantini/humblapi/pulls)
...
---
A lightweight Fast API app to connect humnlDATA and humblFINANCE
...
_Python package_: to add and install this package as a dependency of your project, run `poetry add humblapi`.
...
1. ⭐️ _Dev Container (with container volume)_: click on [Open in Dev Containers](https://vscode.dev/redirect?url=vscode://ms-vscode-remote.remote-containers/cloneInVolume?url=https://github.com/humblFINANCE/humblFINANCE-api) to clone this repository in a container volume and create a Dev Container with Cursor AI/VS Code.
...
See also the list of [contributors](https://github.com/jjfantini/humblapi/contributors) who participated in this project.
